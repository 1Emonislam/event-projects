...
const { registerUser, loginUser, updateUser, getAllUsers, makeAdmin, getAllAdmins, getSingleUser, getAdmin, currentProfile, removeAdmin, userListSearch, AdminListSearch } = require('../constrollers/userControllers');
...
router.route('/adminList').get(AdminListSearch)
